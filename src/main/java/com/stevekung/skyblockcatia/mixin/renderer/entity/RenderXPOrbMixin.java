...
public abstract class RenderXPOrbMixin extends Render<Entity>
{
    ...
    public void doRender(Entity entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        worldrenderer.pos(-0.5D, -0.25D, 0.0D).tex(f, f3).color(l, 255, j1, 128).normal(0.0F, 1.0F, 0.0F).endVertex();
        worldrenderer.pos(0.5D, -0.25D, 0.0D).tex(f1, f3).color(l, 255, j1, 128).normal(0.0F, 1.0F, 0.0F).endVertex();
        worldrenderer.pos(0.5D, 0.75D, 0.0D).tex(f1, f2).color(l, 255, j1, 128).normal(0.0F, 1.0F, 0.0F).endVertex();
        worldrenderer.pos(-0.5D, 0.75D, 0.0D).tex(f, f2).color(l, 255, j1, 128).normal(0.0F, 1.0F, 0.0F).endVertex();
        tessellator.draw();
