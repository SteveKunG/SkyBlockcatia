...
public enum HitboxRenderMode
{
    ...
    private static final HitboxRenderMode[] VALUES = Arrays.stream(values()).sorted(Comparator.comparingInt(HitboxRenderMode::getId)).toArray(id -> new HitboxRenderMode[id]);
