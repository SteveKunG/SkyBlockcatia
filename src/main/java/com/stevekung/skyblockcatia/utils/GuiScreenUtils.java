...
public class GuiScreenUtils
{
    ...
    public static boolean contains(List<String> invList, ITextComponent title)
    {
        return invList.stream().anyMatch(title.getString()::contains);
    }

    public static boolean equals(List<String> invList, ITextComponent title)
    {
        return invList.stream().anyMatch(title.getString()::equals);
    }

    public static boolean isChatable(ITextComponent title)
    {
