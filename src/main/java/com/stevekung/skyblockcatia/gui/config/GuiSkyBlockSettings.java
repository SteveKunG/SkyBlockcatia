...
public class GuiSkyBlockSettings extends GuiScreen
{
    ...
    private static final SkyBlockcatiaSettings.Options[] MISC_OPTIONS = { SkyBlockcatiaSettings.Options.RIGHT_CLICK_ADD_PARTY, SkyBlockcatiaSettings.Options.SNEAK_TO_OPEN_INVENTORY_WHILE_FIGHT_DRAGON, SkyBlockcatiaSettings.Options.ONLY_MINEABLE_HITBOX, SkyBlockcatiaSettings.Options.LOBBY_PLAYER_COUNT, SkyBlockcatiaSettings.Options.SHOW_OBTAINED_DATE };
