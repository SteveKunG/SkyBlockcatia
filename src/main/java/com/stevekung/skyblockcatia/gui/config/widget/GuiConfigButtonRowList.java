...
import com.stevekung.skyblockcatia.config.SkyBlockcatiaSettings.Options;
...
public class GuiConfigButtonRowList extends GuiListExtended
{
    ...
    public GuiConfigButtonRowList(int width, int height, int top, int bottom, int slotHeight, SkyBlockcatiaSettings.Options[] options, boolean singleRow)
    {
        ...
        else
        {
            ...
            {
                SkyBlockcatiaSettings.Options exoptions = options[i];
                SkyBlockcatiaSettings.Options exoptions1 = i < options.length - 1 ? options[i + 1] : null;
    ...
    private GuiButton createButton(int x, int y, int width, SkyBlockcatiaSettings.Options options)
    {
        if (options == null)
        {
            return null;
