...
//
//public class GuiChatExtended implements IGuiChat, IDropboxCallback TODO
//{
...
//        this.mode = ChatMode.VALUES[ExtendedConfig2.instance.chatMode];
//    }
//
//    @Override
...
//        {
//            if (this.prevSelect != ExtendedConfig2.instance.selectedHypixelMinigame)
//            {
//                this.updateButton(buttonList, width, height);
//                this.prevSelect = ExtendedConfig2.instance.selectedHypixelMinigame;
//            }
//
...
//            ExtendedConfig2.instance.chatMode = 0;
//            break;
//        case 201:
//            this.mode = ChatMode.PARTY;
//            player.sendChatMessage("/chat p");
//            ExtendedConfig2.instance.chatMode = 1;
//            break;
//        case 202:
//            this.mode = ChatMode.GUILD;
//            player.sendChatMessage("/chat g");
//            ExtendedConfig2.instance.chatMode = 2;
//            break;
//        case 203:
//            this.mode = ChatMode.SKYBLOCK_COOP;
//            ExtendedConfig2.instance.chatMode = 3;
//            break;
//        }
//    }
//
...
//    {
//        ExtendedConfig2.instance.selectedHypixelMinigame = selection;
//        ExtendedConfig2.instance.save();
//    }
//
//    @Override
...
//    {
//        return ExtendedConfig2.instance.selectedHypixelMinigame;
//    }
//
...
//            }
//            if (!SkyBlockcatiaConfig.enableShortcutGameButton)
//            {
//                return;
//            }
//
...
//            {
//                this.prevSelect = 0;
//                ExtendedConfig2.instance.selectedHypixelMinigame = 0;
//            }
//
//            for (MinigameData data : MinigameData.getMinigameData())
//            {
