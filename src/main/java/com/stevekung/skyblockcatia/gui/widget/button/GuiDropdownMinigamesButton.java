...
public class GuiDropdownMinigamesButton extends GuiButton
{
    private static final ResourceLocation texture = new ResourceLocation("skyblockcatia:textures/gui/dropdown.png");
    ...
    public GuiDropdownMinigamesButton(IDropboxCallback parentClass, int x, int y, List<String> minigameLists)
    {
        super(0, x, y, 15, 15, "");
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY)
    {
        ...
        if (this.visible)
        {
            ...
            mc.renderEngine.bindTexture(GuiDropdownMinigamesButton.texture);
    ...
    {
        void onSelectionChanged(GuiDropdownMinigamesButton dropdown, int selection);

        int getInitialSelection(GuiDropdownMinigamesButton dropdown);
    }
}