...
public class GuiErrorInfoScrollingList extends GuiScrollingList
{
    private final List<String> error;
    private final GuiScreen parent;

    public GuiErrorInfoScrollingList(GuiScreen parent, int width, int height, int top, int bottom, int left, int entryHeight, int parentWidth, int parentHeight, List<String> error)
    {
