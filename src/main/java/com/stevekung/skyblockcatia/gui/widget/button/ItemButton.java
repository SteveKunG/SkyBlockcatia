...
public class ItemButton extends Button
{
    ...
    {
        this(xPos, yPos, item, true, item.getDisplayName(new ItemStack(item)), onPress);
    }

    public ItemButton(int xPos, int yPos, Item item, boolean condition, Button.IPressable onPress)
    {
        this(xPos, yPos, item, condition, item.getDisplayName(new ItemStack(item)), onPress);
    }

    public ItemButton(int xPos, int yPos, Item item, ITextComponent customName, Button.IPressable onPress)
    {
        this(xPos, yPos, item, true, customName, onPress);
    }

    public ItemButton(int xPos, int yPos, Item item, boolean condition, ITextComponent customName, Button.IPressable onPress)
    {
