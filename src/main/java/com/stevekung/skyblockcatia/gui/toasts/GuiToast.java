...
//
//public class GuiToast extends Gui TODO
//{
...
//            boolean shiftY = SkyBlockcatiaConfig.enableShortcutGameButton && Minecraft.getMinecraft().ingameGUI.getChatGUI().getChatOpen();
//
