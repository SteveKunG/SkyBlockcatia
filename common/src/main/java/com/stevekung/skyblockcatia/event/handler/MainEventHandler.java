...
//    {
//        if (SkyBlockEventHandler.isSkyBlock && ChatFormatting.stripFormatting(event.getLines().get(0).getString()).equals(" "))
//        {
...
//                    {
//                        event.addWidget(new ItemButton(width + 88, height + 47, Blocks.CRAFTING_TABLE, button -> this.mc.player.chat("/craft")));
//                        event.addWidget(new ItemButton(width + 88, height + 66, Blocks.ENDER_CHEST, button -> this.mc.player.chat("/enderchest")));
//                        event.addWidget(new ItemButton(width + 88, height + 85, skyBlockMenu, button -> this.mc.player.chat("/sbmenu")));
//                    }
//                    else if (title.getString().equals("Craft Item"))
//                    {
//                        event.addWidget(new ItemButton(width + 88, height + 47, Blocks.ENDER_CHEST, button -> this.mc.player.chat("/enderchest")));
//                        event.addWidget(new ItemButton(width + 88, height + 66, skyBlockMenu, button -> this.mc.player.chat("/sbmenu")));
//                    }
...
//                    {
//                        event.addWidget(new ItemButton(width + 88, height + 47, Items.BONE, TextComponentUtils.component("Pets"), button -> this.mc.player.chat("/pets")));
//                    }
//                    else if (title.getString().contains("Pets"))
//                    {
//                        event.addWidget(new ItemButton(width + 88, height + 47, wardRobeItem, TextComponentUtils.component("Wardrobe"), button -> this.mc.player.chat("/wardrobe")));
//                    }
//                }
//
...
//        Screen gui = event.getGui();
//
//        for (ItemButton button : gui.buttons.stream().filter(button -> button instanceof ItemButton).map(button -> (ItemButton)button).collect(Collectors.toList()))
//        {
...
//            {
//                GuiUtils.drawHoveringText(event.getMatrixStack(), Collections.singletonList(button.getName()), event.getMouseX(), event.getMouseY(), gui.width, gui.height, -1, this.mc.font);
...
//        {
//            TitleScreen menu = (TitleScreen)event.getGui();
//
...
//    {
//        event.addWidget(new ItemButton(width - 9, height + 86, Blocks.ENDER_CHEST, button -> this.mc.player.chat("/enderchest")));
//        event.addWidget(new ItemButton(width + 10, height + 86, Blocks.CRAFTING_TABLE, button -> this.mc.player.chat("/craft")));
//        event.addWidget(new ItemButton(width + 29, height + 86, Items.BONE, TextComponentUtils.component("Pets"), button -> this.mc.player.chat("/pets")));
//        event.addWidget(new ItemButton(width + 48, height + 86, wardRobeItem, TextComponentUtils.component("Wardrobe"), button -> this.mc.player.chat("/wardrobe")));
...
//        event.getGui().children().removeIf(widget -> widget instanceof ItemButton || widget instanceof SmallArrowButton);
//        this.addButtonsToInventory(event, wardRobeItem, width, height);
//    }
}