...
public class SBItemUtils
{
    ...
    public static List<ItemStack> decodeItem(JsonObject currentProfile, InventoryType type)
    {
        if (currentProfile.has(type.getApiName()))
        {
            ...
            try
            {
                ...
                ListTag list = compound.getList("i", Constants.NBT.TAG_COMPOUND);
    ...
    public static ItemStack flatteningItemStack(CompoundTag apiCompound)
    {
        ...
        if (sbTag != null)
        {
            ...
            ListTag sbLore = sbTag.getCompound("display").getList("Lore", Constants.NBT.TAG_STRING);
            ...
            {
                ListTag enchantmentList = sbTag.getList("ench", Constants.NBT.TAG_COMPOUND);
