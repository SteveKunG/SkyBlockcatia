            ...
            if (extra.contains("id"))
            {
                        ...
                        for (int j1 = 0; j1 < list.size(); ++j1)
                        {
                            try
                            {
                                ...
                                if (lore.getString().contains("COSMETIC")) // temp
                                {
                                    ...
                                    if (color != null)
                                    {
                                        SBRenderUtils.renderRarity(matrixStack, xPos, yPos, SBRarity.byBaseColor(ChatFormatting.getByName(color.getColor().toString()).toString()));
                                    }
                                    else
                                    {
                ...
                try
                {
                    for (Component component2 : itemStack.getHoverName().getSiblings())
                    {
                        if (displayName.matches("\\d.*"))
                        {
                            for (int i = 0; i < component2.getSiblings().size(); i++)
                            {
                                if (i == 1)
                                {
                                    ...
                                    SBRenderUtils.renderRarity(matrixStack, xPos, yPos, SBRarity.byBaseColor(ChatFormatting.getByName(color.getStyle().getColor().toString()).toString()));
                                    break;
                                }
                            }
                        }
                        ...
                        for (Component component3 : component2.getSiblings())
                        {
                            SBRenderUtils.renderRarity(matrixStack, xPos, yPos, SBRarity.byBaseColor(ChatFormatting.getByName(component3.getStyle().getColor().toString()).toString()));
                            break;
                        }
                    }
